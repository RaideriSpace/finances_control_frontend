...
export const metadata: Metadata = {
  ...
  description: "RailLink é um gerenciador financeiro inteligente que ajuda você a controlar despesas, receitas e saldos com facilidade. Organize suas finanças em um só lugar.",
  keywords: [
